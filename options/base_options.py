...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='/home5/shuyezhi/ComboGAN-modify-multiple/datasets/spirit_xhc_paprika/', help='path to images (should have subfolders train0, train1_stylename, train2_stylename, ..., edge1_stylename, edge2_stylename, ..., test)')
